...
def analyze_starting_position_bias(trials: list[dict], min_duration: float = 0.1, max_duration: float = 10.0,
    ...
    # Overall title
    title = f'Starting Position Bias Analysis (avg {window_start}-{window_end}s): Left vs Right Targets'
    if animal_id:
        title += f' - {animal_id}'
    if session_date:
        title += f' ({session_date})'
...
def analyze_ending_position_bias(trials: list[dict], min_duration: float = 0.1, max_duration: float = 10.0,
    ...
    # Overall title
    title = f'Final Position Bias Analysis (avg last {window_duration}s): Left vs Right Targets'
    if animal_id:
        title += f' - {animal_id}'
    if session_date:
        title += f' ({session_date})'
